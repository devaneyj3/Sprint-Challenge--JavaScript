...
console.log(`The tyrannosaurus weighs ${tRex.weight}`);

// What was the diet of a velociraptor?
console.log(`The velociraptor diet is ${velociraptor.diet}`);

// How long was a stegosaurus?
console.log(`The stegosaurus is ${stegosaurus.length} long`);

// What time period did tyrannosaurus live in?
console.log(`The tyrannosaurus lives in the ${tRex.period}`);


// Create a new roar method for the tyrannosaurus.  When called, return "RAWERSRARARWERSARARARRRR!" Log the result.
console.log(`The tyrannosaurus ${tRex.roar()}`);
...
///come back to reccorrect this one
